...
/// ////////////////////////////////////////////////////////SUFFIX ARRAY WITH DC3///////////////////
/// sa array contains Suffix Array
/// lcp array as Longest Common Prefix Count
string str;
...
void print() {
    ...
    cout<<"\nLCP:\n";
    for(int i = 0; i<n; i++) {
        cout<<i<<" : LCP : "<<lcp[i]<<" : "<<sa[i]<<" -> "<<str.substr(sa[i])<<endl;
    }

}

/// ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// Number of Distinct Substring = total Substring (sum of len) - sumOfLcpArray

/// ////////////
int main() {
    cin >> str;
    //str = "abracadabra0AbRa4Cad14abra";
    n = str.length();
    Generate();
    LcpArray();
    for(int i = 0; i < n ; i++)
